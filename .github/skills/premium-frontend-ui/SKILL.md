...
description: 'Craft immersive, high-performance web experiences with advanced motion design, animations, and architectural craftsmanship. Use when: building premium landing pages, creating hero sections, implementing scroll-driven animations, designing interactive portfolios, adding micro-interactions, creating custom cursors, implementing parallax effects, building cinematic UI, using GSAP/Framer Motion, creating glassmorphism effects, optimizing animation performance, designing award-level frontends.'
metadata:
