        ...
        <div className="flex flex-wrap justify-center gap-4">
          {skills.map((skill, i) => (
            <FadeIn key={skill.name} delay={i * 0.05}>
              <div className="flex flex-col items-center justify-center p-2 rounded-xl bg-[var(--color-background)] border border-[var(--color-border)] hover:border-[var(--color-accent)] transition-colors w-[120px] h-[110px]">
                <i className={skill.icon} style={{ fontSize: "1.60rem" }}></i>
