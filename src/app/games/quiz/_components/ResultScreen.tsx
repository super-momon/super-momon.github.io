  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-4 py-20">
      <div
        ...
        style={{ maxWidth: showLeaderboard ? '900px' : '460px', transition: 'max-width 0.4s ease' }}
      >
        <div className="w-full flex flex-col items-center lg:max-w-115 lg:shrink-0">
        <motion.div
          variants={container}
          initial="hidden"
          animate="show"
        ...
        <AnimatePresence>
          {showLeaderboard && (
            <motion.div
              ...
              className="w-full lg:w-90 lg:shrink-0 mt-4 lg:mt-0 lg:sticky lg:top-8"
            >
              <Leaderboard
                initialMode={mode}
